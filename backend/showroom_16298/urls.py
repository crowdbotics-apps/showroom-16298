"""showroom_16298 URL Configuration
...
admin.site.site_header = "Showroom"
admin.site.site_title = "Showroom Admin Portal"
admin.site.index_title = "Showroom Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="Showroom API",
        default_version="v1",
        description="API documentation for Showroom App",
    ),
    public=True,
